...
public enum ChatUserRole {
    ...
    USER(Arrays.asList(ADD_CHAT_USER,READ_SELF_CHATS_INFO,READ_SELF_CHAT_MESSAGES,
            MODIFY_SELF_INFO,DELETE_SELF,
    ...
    ADMIN(Arrays.asList(READ_SELF_CHATS_INFO,READ_SELF_CHAT_MESSAGES,
            ...
            DELETE_SELF_CHAT_MESSAGES, MODIFY_ANY_CHAT_MESSAGE, DELETE_ANY_CHAT_MESSAGE)),
