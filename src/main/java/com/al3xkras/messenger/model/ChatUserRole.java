...
public enum ChatUserRole {
    ...
    USER(Arrays.asList(ADD_CHAT_USER,READ_SELF_CHATS_INFO,MODIFY_SELF_INFO,DELETE_SELF,
            VIEW_MESSAGES,SEND_MESSAGES,MODIFY_SELF_CHAT_MESSAGES)),

    ADMIN(Arrays.asList(READ_SELF_CHATS_INFO,READ_ANY_CHATS_INFO_EXCEPT_SELF,
