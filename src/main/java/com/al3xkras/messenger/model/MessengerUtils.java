...
public final class MessengerUtils {
    ...
    public enum Property {
        ...
        GUI_SERVICE_NAME(messenger.getString("gui-service.name")),
        ...
        GUI_SERVICE_URI("http://"+messenger.getString("messenger.host")+":"+messenger.getString("gui-service.port")+messenger.getString("gui-service.uri.prefix")),
