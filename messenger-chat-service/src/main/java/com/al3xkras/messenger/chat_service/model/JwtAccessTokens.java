...
public class JwtAccessTokens {
    ...
    public String getUserServiceAccessToken() throws Exception {
        ...
        if (accessToken==null || refreshToken==null)
            throw new IllegalStateException(String.format(MessengerUtils.Messages.EXCEPTION_AUTH_TOKEN_IS_NULL.value(),
                    MessengerUtils.Property.USER_SERVICE_NAME.value()));
